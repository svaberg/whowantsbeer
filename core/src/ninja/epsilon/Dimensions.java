...
public class Dimensions {
	...
	public static final int BAR_COUNTER_CAPACITY = 4;
	public static final int BAR_MEAN_TIME_BETWEEN_DRINKERS = 4000;
	...
	public static final long DRINKER_PERSISTENCE_TIME = 30000;
	private Dimensions() {
	}
}
